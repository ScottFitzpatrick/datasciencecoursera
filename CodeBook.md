...
# this CodeBook file intends to explain the variables discussed in the README.md file that accompanies the run_analysis.R script
...
The set of variables that were included [as a subset of the original measurements] from these signals are: 
